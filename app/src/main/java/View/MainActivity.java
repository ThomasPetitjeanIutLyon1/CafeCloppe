...
import com.example.tpn.cafecloppe.R;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userPic = hView.findViewById(R.id.userProfilePicture);
        userEmail = hView.findViewById(R.id.userMail);
        this.setNavDrawer();
    }
    ...
    private void setNavDrawer(){
        ...
        try{
            ...
            String j = acct.getPhotoUrl().toString();
            Picasso.get().load(j)
                    .resize(10, 10)
                    .centerCrop()
                    .into(userPic);
